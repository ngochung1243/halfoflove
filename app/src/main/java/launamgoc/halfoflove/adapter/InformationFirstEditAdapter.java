...
import launamgoc.halfoflove.activity.FirstEditProfileActivity;
...
public class InformationFirstEditAdapter extends
        RecyclerView.Adapter<InformationFirstEditAdapter.InformationHolder>{

    private List<Information> listView = new ArrayList<>();

    public InformationFirstEditAdapter(List<Information> listView) {
        ...
        public void load(@NonNull final Information data) {
            ...
            layoutEditItem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    FirstEditProfileActivity activity = (FirstEditProfileActivity) view.getContext();
